    ...
    >
      <section>
        <div className="container my-7 text-center">
          {!isApp && <BannerAd key="banner-ad-index-1" />}
          ...
          {!isApp && <BannerAd key="banner-ad-index-2" />}
          ...
          {!isApp && <BannerAd key="banner-ad-index-3" />}
          <div className="mb-10">
          ...
          {!isApp && <BannerAd key="banner-ad-index-4" />}
          <div className="my-10">
          ...
          {!isApp && <BannerAd key="banner-ad-index-5" />}
        </div>
      </section>
    </Base>
  );
