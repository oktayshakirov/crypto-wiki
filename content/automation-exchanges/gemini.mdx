...
- **Trading Platform:**  
  - **Spot Trading:** Gemini supports 70+ cryptocurrencies in the U.S. and 100+ globally, with 100+ trading pairs across majors like BTC and ETH and selective altcoins. Users can place market, limit, and stop-limit orders.  
...
- **Custody and Wallets:**  
  - **Gemini Custody:** Qualified, regulated custody with segregated cold storage, detailed account-level reporting, and institutional-grade access controls. Most customer assets are stored offline in geographically distributed, access-controlled facilities.  
...
![Screenshot of Gemini cryptocurrency exchange trading interface showing order book, charts, and trading pairs](/images/posts/gemini-trading-interface.png)

## Security Measures

- **Account Security:**  
  - **Two-Factor Authentication (2FA):** Strongly encouraged for all accounts, with support for time-based one-time passwords (TOTP) and hardware security keys (FIDO2/WebAuthn).  
...
- **Interface and Accessibility:**  
  - **Retail App:** A streamlined app for quick buys, recurring purchases, price alerts, and basic portfolio tracking. Suitable for beginners and long-term allocators who prioritize simplicity.  
...
![Illustration of Gemini’s compliance and user experience lifecycle with onboarding, KYC, trading, and custody flows](/images/posts/gemini-compliance-overview.png)
