---
title: "Elon Musk"
meta_title: "Elon Musk and Crypto: Bitcoin, Dogecoin & Tesla's Holdings"
...
quickFacts:
  ...
  nationality: "American, Canadian and South African"
  education: "University of Pennsylvania (physics and economics)"
  knownFor: "Tesla, SpaceX and X; prominent Dogecoin commentary"
  role: "Chief Executive of Tesla and SpaceX"
faqs:
  - question: "What is Elon Musk's connection to Dogecoin?"
    answer: "Musk has commented on Dogecoin publicly since around 2019, and his posts have repeatedly coincided with sharp price movements. Tesla and SpaceX have at points accepted Dogecoin for selected merchandise. He has never claimed it to be an investment recommendation."
  - question: "Does Tesla own Bitcoin?"
    answer: "Tesla bought Bitcoin in early 2021 and briefly accepted it for vehicle purchases before suspending that over energy-use concerns. It sold a large portion of the holding in 2022 while retaining some. Current holdings are disclosed in Tesla's quarterly filings."
social:
