...
meta_title: "Sergey Nazarov Wiki: Bio, Chainlink & Decentralized Oracles"
...
quickFacts:
  ...
  knownFor: "Co-founding Chainlink, the decentralized oracle network"
  role: "Co-founder of Chainlink"
faqs:
  - question: "Who is Sergey Nazarov?"
    answer: "Sergey Nazarov co-founded Chainlink, the decentralized oracle network that supplies external data to smart contracts. He is known for keeping a comparatively low public profile and focusing on enterprise and institutional adoption."
  - question: "What is Chainlink and why do oracles matter?"
    answer: "Smart contracts cannot access data outside their own blockchain. Chainlink is a decentralized oracle network that feeds external information, such as asset prices, into contracts. This matters because much of decentralized finance depends on accurate price data, and a manipulated or failed feed can cause large losses."
social:
...
![A world map lit up at night, the global off-chain data Chainlink oracles feed into smart contracts](/images/posts/global-map.jpg)
