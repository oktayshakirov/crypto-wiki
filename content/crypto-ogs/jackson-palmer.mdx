...
Shortly after, Billy Markus, a software engineer at IBM, saw Palmer's website and contacted him with the technical expertise to turn the parody into a functioning cryptocurrency. Markus forked the codebase of Luckycoin (which itself was derived from **Litecoin**) and adapted it to create Dogecoin. Litecoin's Scrypt algorithm and **[Proof-of-Work](/posts/common-crypto-terms)** consensus mechanism formed Dogecoin's technical foundation, allowing for a relatively quick development process.
