...
- **Ouroboros Proof-of-Stake:** Cardano utilizes **Ouroboros**, a family of bespoke **[Proof-of-Stake (PoS)](/posts/crypto-staking)** consensus protocols developed by IOHK and academic partners. Ouroboros was one of the first PoS protocols with mathematically proven security guarantees and is significantly more energy-efficient than **[Proof-of-Work (PoW)](/posts/common-crypto-terms)** systems like Bitcoin's.
