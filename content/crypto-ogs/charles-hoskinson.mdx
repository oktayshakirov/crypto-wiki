...
meta_title: "Charles Hoskinson: Cardano Founder & Ethereum Co-Founder"
...
quickFacts:
  ...
  knownFor: "Co-founding Ethereum and founding Cardano"
  role: "Chief Executive of Input Output (IOHK)"
faqs:
  - question: "Who is Charles Hoskinson?"
    answer: "Charles Hoskinson was one of the eight original co-founders of Ethereum and later founded Cardano, which he develops through Input Output (formerly IOHK). He left the Ethereum project in 2014 after disagreements over whether it should be a commercial entity."
  - question: "Why did Charles Hoskinson leave Ethereum?"
    answer: "He favoured structuring Ethereum as a commercial company with outside investment, while others, including Vitalik Buterin, preferred a non-profit foundation. He departed in 2014 after that disagreement was resolved against his position."
  - question: "What is Cardano?"
    answer: "Cardano is a Proof-of-Stake blockchain founded by Hoskinson, notable for its research-led development approach in which protocol changes are published as peer-reviewed academic papers before implementation."
social:
