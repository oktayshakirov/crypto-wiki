---
title: "Joseph Lubin"
meta_title: "Joseph Lubin: Ethereum Co-Founder & ConsenSys Founder"
image: "/images/crypto-ogs/joseph-lubin.jpg"
description: "Ethereum co-founder and ConsenSys founder who scaled Web3 infrastructure with MetaMask and Infura."
date: 2025-10-25
updated: 2026-07-24
order: 26
...
quickFacts:
  ...
  knownFor: "Co-founding Ethereum and founding ConsenSys"
  role: "Chief Executive of ConsenSys"
faqs:
  - question: "Who is Joseph Lubin?"
    answer: "Joseph Lubin is one of Ethereum's eight co-founders and the founder of ConsenSys, the software company behind MetaMask and Infura. ConsenSys has been one of the most significant builders of Ethereum developer infrastructure."
  - question: "What is ConsenSys?"
    answer: "ConsenSys is a blockchain software company founded by Lubin in 2014. Its best known products are MetaMask, the widely used self-custody browser wallet, and Infura, infrastructure that many applications rely on to connect to Ethereum."
social:
...
![Ethereum network visualization showing interconnected nodes and blockchain architecture](/images/posts/ethereum-network.jpg)
...
![Ethereum logo featuring the distinctive diamond-shaped symbol representing the decentralized blockchain platform](/images/posts/ethereum.jpg)
...
Following years of research and testnets, Ethereum's transition to
**Proof-of-Stake** in 2022 - popularly known as
"the Merge" - reduced network energy consumption dramatically while cementing the
staking economy at the protocol layer. For builders and users, this shift
accelerated infrastructure innovation and raised the stakes for wallet UX,
validator tooling, and chain access - all areas where ConsenSys contributed.
