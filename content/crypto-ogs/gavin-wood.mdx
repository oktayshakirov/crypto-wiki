---
title: "Gavin Wood"
meta_title: "Gavin Wood Wiki: Bio, Ethereum Co-Founder & Polkadot"
...
quickFacts:
  born: "1980"
  nationality: "British"
  education: "University of York (PhD in computer science)"
  knownFor: "Co-founding Ethereum, authoring the Yellow Paper, and coining the term Web3"
  role: "Founder of Polkadot and Parity Technologies"
faqs:
  - question: "Who is Gavin Wood?"
    answer: "Gavin Wood is a British computer scientist who co-founded Ethereum and served as its first chief technology officer. He wrote the Ethereum Yellow Paper, the formal technical specification of the protocol, created the Solidity smart contract language, and later founded Polkadot and Parity Technologies."
  - question: "What is Gavin Wood's net worth?"
    answer: "Public estimates of Gavin Wood's net worth vary widely and move with cryptocurrency prices, so any single figure dates quickly. Published estimates have placed it in the hundreds of millions to low billions of dollars, largely tied to DOT and early ETH holdings. These are outside estimates based on assumed holdings rather than disclosed figures, and holdings of this kind are rarely disclosed, so treat any precise number with caution."
  - question: "Did Gavin Wood coin the term Web3?"
    answer: "Yes. He used the term in 2014 to describe a decentralised web in which users control their own data and identity through cryptographic protocols rather than trusting centralised platforms."
  - question: "What is Gavin Wood's role at Polkadot?"
    answer: "He founded Polkadot and Parity Technologies and remains its central technical figure, though he stepped back from the chief executive role at the Web3 Foundation to focus on research and protocol architecture."
social:
