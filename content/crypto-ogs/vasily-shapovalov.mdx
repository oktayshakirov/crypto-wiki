...
meta_title: "Vasily Shapovalov: Lido Co-Founder & Liquid Staking"
...
quickFacts:
  knownFor: "Co-founding Lido, the largest liquid staking protocol"
  role: "Co-founder of Lido and chief technology officer of P2P.org"
faqs:
  - question: "Who is Vasily Shapovalov?"
    answer: "Vasily Shapovalov is a co-founder of Lido, the liquid staking protocol that became the largest single holder of staked Ether, and serves as chief technology officer at the staking infrastructure provider P2P.org. He keeps a relatively low public profile compared with other figures of similar influence."
  - question: "What is Lido and why does it matter?"
    answer: "Lido lets users stake Ether without running a validator or locking up 32 ETH, issuing stETH in return, which stays liquid and usable across decentralized finance. Its scale has also drawn scrutiny, because a single protocol controlling a large share of staked ETH raises questions about network decentralisation."
social:
...
Vasiliy Shapovalov stands as a significant technical contributor within the **DeFi**
and **Proof-of-Stake** sectors. His work as a co-founder
