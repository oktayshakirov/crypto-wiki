---
title: "Hayden Adams"
meta_title: "Hayden Adams Wiki: Bio, Founding Uniswap & DeFi Impact"
...
quickFacts:
  ...
  education: "Stony Brook University (mechanical engineering)"
  knownFor: "Creating the Uniswap decentralized exchange protocol in 2018"
  role: "Founder and Chief Executive of Uniswap Labs"
faqs:
  - question: "Who is Hayden Adams?"
    answer: "Hayden Adams created Uniswap, the automated market maker protocol that became the largest decentralized exchange on Ethereum. He built the first version in 2018 after being laid off from a mechanical engineering job and learning to code on the suggestion of a friend."
  - question: "How does Uniswap work?"
    answer: "Uniswap replaces the traditional order book with liquidity pools and a constant-product formula. Anyone can supply two tokens to a pool and earn a share of trading fees, while traders swap against the pool directly from their own wallet, with no account or intermediary."
  - question: "What is Hayden Adams's technical contribution?"
    answer: "He turned the automated market maker concept, discussed in posts by Vitalik Buterin and others, into a working, permissionless, widely adopted protocol. Uniswap's design has since been copied and adapted across nearly every blockchain ecosystem."
social:
