...
meta_title: "Michael Saylor Wiki: Bio, Net Worth, Bitcoin & Strategy"
...
quickFacts:
  ...
  education: "Massachusetts Institute of Technology (aeronautics and astronautics; science, technology and society)"
  knownFor: "Pioneering the corporate Bitcoin treasury strategy"
  role: "Executive Chairman of Strategy (formerly MicroStrategy)"
faqs:
  - question: "Who is Michael Saylor?"
    answer: "Michael Saylor co-founded the business intelligence company MicroStrategy, since rebranded as Strategy, in 1989. From 2020 he directed the company to convert its cash reserves into Bitcoin, pioneering the corporate Bitcoin treasury strategy that many other listed companies later imitated."
  - question: "Is Michael Saylor the CEO of MicroStrategy?"
    answer: "Not any longer. He stepped down as chief executive in August 2022 and became Executive Chairman, a move he described as letting him focus on Bitcoin strategy while Phong Le took over day-to-day operations. The company rebranded from MicroStrategy to Strategy in 2025."
  - question: "What is Michael Saylor's net worth?"
    answer: "Public estimates of Michael Saylor's net worth vary widely and move with cryptocurrency prices, so any single figure dates quickly. Published estimates have placed it in the billions of dollars, tied to his personal Bitcoin holdings and his stake in Strategy. These are outside estimates based on assumed holdings rather than disclosed figures, and both components swing sharply with the Bitcoin price, so treat any precise number with caution."
  - question: "How much Bitcoin does Michael Saylor own?"
    answer: "Saylor stated in 2020 that he personally held roughly 17,732 BTC, separate from his company's far larger corporate holdings. Strategy's corporate holdings are disclosed in its regulatory filings and have grown substantially, so consult current filings for up-to-date figures."
  - question: "What did Michael Saylor study?"
    answer: "He attended the Massachusetts Institute of Technology on an ROTC scholarship, taking a dual degree in aeronautics and astronautics and in science, technology and society."
social:
...
**Michael Saylor (born 1965) is an American entrepreneur, co-founder and Executive Chairman of Strategy (formerly MicroStrategy, NASDAQ: MSTR), and the best-known corporate advocate for Bitcoin.** Under his direction the company began buying **[Bitcoin](/posts/what-is-bitcoin)** as its primary treasury reserve asset in 2020 and now holds one of the largest corporate stashes in the world.

A graduate of MIT, Saylor founded MicroStrategy as a business-intelligence software firm in 1989. Since 2020 his public advocacy has made him one of the most influential voices shaping how institutions think about digital assets.
