---
title: "Pavel Durov"
meta_title: "Pavel Durov: Telegram Founder, TON Blockchain & Arrest"
...
quickFacts:
  ...
  nationality: "Russian, French and Emirati"
  education: "Saint Petersburg State University (philology)"
  knownFor: "Founding VK and Telegram"
  role: "Chief Executive of Telegram"
faqs:
  - question: "Who is Pavel Durov?"
    answer: "Pavel Durov founded the Russian social network VK and later Telegram, the encrypted messaging platform. He left Russia in 2014 after refusing state demands for user data, and Telegram has since become central to crypto community communication."
  - question: "What is Telegram's connection to crypto?"
    answer: "Telegram originally developed the TON blockchain but abandoned the project in 2020 after US regulators blocked its token sale. The open-source community continued it as The Open Network, and Telegram has since integrated TON-based wallet features."
  - question: "What happened to Pavel Durov in France?"
    answer: "Durov was detained in France in August 2024 in connection with an investigation into criminal activity conducted through Telegram. He was later released under judicial supervision. He has rejected the notion that a platform owner is personally responsible for users' misuse of it."
social:
