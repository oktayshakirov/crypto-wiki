...
![A golden Ethereum coin surrounded by scattered coins on a dark background](/images/posts/ethereum-network.jpg)
...
When interacting with smart contracts - swaps, staking, NFT mints - gas units scale with complexity. A token swap on a decentralized exchange like **[Uniswap](/exchanges/uniswap)** might use 120,000 - 200,000 gas. Using our same 22 gwei effective price, that is 0.00264 - 0.0044 ETH, around $7.92 - $13.20 at $3,000/ETH. This is why active DeFi users care about fee conditions. For a grounding in decentralized applications and the contract calls that drive most of this gas usage, see **[What is DeFi (Decentralized Finance)?](/posts/what-is-defi)**.
...
![A glowing blue and purple network of connected nodes representing blockchain layers](/images/posts/layer-2-blockchain.jpg)
