...
The most common cryptocurrencies in ETFs are those with large market capitalizations, established track records, and significant trading volumes. Bitcoin (BTC) and Ethereum (ETH) were pioneers. Beyond these, fund managers are actively pursuing ETFs for other prominent cryptocurrencies like [Solana](/posts/what-is-solana) (if a specific post exists, otherwise remove link), XRP, and Avalanche (AVAX). Applications for Litecoin (LTC) and HBAR also signal broadening interest.
...
| Fund Name                           | Issuer              | Type                  | Approx. AUM  | Expense Ratio |
| :---------------------------------- | :------------------ | :-------------------- | :----------- | :------------ |
| iShares Bitcoin Trust (IBIT)        | BlackRock           | Spot ETF              | ~$70.39B USD | 0.25%         |
| Fidelity Wise Origin Bitcoin (FBTC) | Fidelity            | Spot ETF              | ~$20.99B USD | 0.25%         |
| Grayscale Bitcoin Trust (GBTC)      | Grayscale           | Spot ETF (converted)  | ~$19.63B USD | 1.50%         |
| ARK 21Shares Bitcoin ETF (ARKB)     | ARK Invest/21Shares | Spot ETF              | ~$4.99B USD  | 0.21%         |
| Bitwise Bitcoin ETF (BITB)          | Bitwise             | Spot ETF              | ~$4.02B USD  | 0.20%         |
| ProShares Bitcoin Strategy (BITO)   | ProShares           | Futures ETF           | ~$2B USD     | 0.95%         |
| Franklin Bitcoin ETF (EZBC)         | Franklin Templeton  | Spot ETF              | ~$533.4M USD | 0.19%         |
| CoinShares Physical Bitcoin         | CoinShares          | Physically-backed ETN | ~€1.52B      | 0.25% p.a.    |
| WisdomTree Physical Bitcoin         | WisdomTree          | Physically-backed ETN | ~€1.05B      | 0.15% p.a.    |
| VanEck Bitcoin ETN                  | VanEck              | Physically-backed ETN | ~€675M       | 1.00% p.a.    |
...
| Fund Name                      | Issuer     | Type                                         | Approx. AUM | Expense Ratio   |
| :----------------------------- | :--------- | :------------------------------------------- | :---------- | :-------------- |
| ProShares Ether ETF (EETH)     | ProShares  | Futures ETF, Staking N                       | Varies      | 0.95% (implied) |
| 21Shares Ethereum Staking ETP  | 21Shares   | Physically-backed ETN, Staking Y             | ~€342M      | 1.49% p.a.      |
| CoinShares Physical Staked Eth | CoinShares | Physically-backed ETN, Staking Y             | ~€284M      | 0.00% p.a.      |
| VanEck Ethereum ETN            | VanEck     | Physically-backed ETN, Staking N (typically) | ~€146M      | 1.00% p.a.      |
| WisdomTree Physical Ethereum   | WisdomTree | Physically-backed ETN, Staking N (typically) | ~€111M      | 0.35% p.a.      |
| Bitwise Ethereum Staking ETP   | Bitwise    | Physically-backed ETN, Staking Y             | ~€182M      | 0.65% p.a.      |
...
| Fund Name                                 | Issuer              | Index Tracked                                | Key Cryptos                                            | Approx. AUM | Expense Ratio  |
| :---------------------------------------- | :------------------ | :------------------------------------------- | :----------------------------------------------------- | :---------- | :------------- |
| Hashdex Nasdaq Crypto Index ETF (HDEX.BH) | Hashdex             | Nasdaq Crypto Index™ (NCI™)                  | BTC (77%), ETH (11%), XRP (5%), SOL (4.5%), ADA (1.3%) | ~$804M USD  | N/A (Mgmt Fee) |
| Hashdex Nasdaq Crypto Index Europe ETP    | Hashdex             | Nasdaq Crypto Index™ (NCI™)                  | Similar to HDEX.BH                                     | ~€400M      | 1.00% p.a.     |
| 21Shares Crypto Basket Index ETP (HODLX)  | 21Shares            | Tracks index of top 5 by market cap          | BTC, ETH, others                                       | ~€181M      | 0.99% p.a.     |
...
| CI Galaxy Multi-Crypto ETF (CMCX.U)       | CI Global Asset Mgt | Rules-based, momentum signaling              | BTC, ETH, others                                       | ~$5.05M USD | 1.04% (MER)    |
