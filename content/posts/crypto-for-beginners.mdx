...
2.  **Verification:** Computers on the network (nodes) validate your transaction. They check if you have enough funds and if the transaction follows the network's rules. This validation process is secured by cryptographic methods and consensus mechanisms like **Proof-of-Work (PoW)** (used by Bitcoin, involves solving complex puzzles) or **[Proof-of-Stake (PoS)](/posts/proof-of-work-vs-proof-of-stake)** (used by Ethereum, involves locking up crypto).
