...
![Crypto.com Logo](/images/exchanges/crypto.png)
...
- **Crypto Earn & Staking:** Crypto.com offers ways to potentially earn yield on held assets:
  ...
  - **Staking:** The platform facilitates **[Crypto Staking](/posts/crypto-staking)** for eligible Proof-of-Stake coins (e.g., ETH, SOL, DOT, ADA). Crypto.com manages the technical staking process custodially, distributing network rewards to users minus a service fee. This carries both platform risk and the inherent risks of on-chain staking (like slashing).
