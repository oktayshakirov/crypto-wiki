---
title: "Crypto.com"
meta_title: "Crypto.com Review: Fees, CRO Card, Staking & Is It Safe?"
...
quickFacts:
  founded: "2016 (as Monaco)"
  headquarters: "Singapore"
  founder: "Kris Marszalek, Rafael Melo, Gary Or and Bobby Bao"
  ceo: "Kris Marszalek"
  type: "Centralized exchange and retail app"
  custody: "Custodial"
  token: "CRO"
  availability: "Global; availability of products varies by country"
faqs:
  - question: "What is Crypto.com?"
    answer: "Crypto.com is a Singapore-headquartered cryptocurrency platform founded in 2016, originally under the name Monaco. It offers a retail app, a full exchange, a Visa card programme, staking, and its native token CRO."
  - question: "Is Crypto.com safe?"
    answer: "Crypto.com holds registrations and licences in multiple jurisdictions, publishes proof-of-reserves, and keeps most assets in cold storage. It is a custodial platform, so counterparty risk applies."
  - question: "What are Crypto.com's fees?"
    answer: "Fees differ between the retail app, which builds in a spread, and the Crypto.com Exchange, which uses a tiered maker and taker model with discounts for CRO stakers. The exchange is generally cheaper for active trading."
  - question: "What is CRO?"
    answer: "CRO is Crypto.com's native token. Staking it can unlock card benefits, fee discounts, and higher reward tiers, although the specific card benefits have changed several times over the years."
social:
...
![The Crypto.com Visa card tiers, from Midnight Blue and Ruby Steel up to Obsidian](/images/posts/crypto-cards.png)
...
Crypto.com operates its own native token, CRO (Crypto.com Coin), which serves multiple functions within the platform's ecosystem:
