---
title: "Gemini"
meta_title: "Gemini Wiki: Company Profile, Fees, NYDFS Trust & Safety"
image: "/images/exchanges/gemini.jpg"
description: "Gemini is an NYDFS-regulated New York trust company offering crypto trading, institutional custody and GUSD."
date: 2025-09-15
updated: 2026-07-23
order: 14
...
quickFacts:
  ...
  founder: "Cameron and Tyler Winklevoss"
  type: "Centralized exchange and qualified custodian"
  custody: "Custodial"
  regulation: "New York trust company regulated by the NYDFS"
  token: "GUSD (Gemini Dollar stablecoin)"
  availability: "United States and selected other countries"
faqs:
  - question: "What is Gemini Trust?"
    answer: "Gemini, officially Gemini Trust Company, LLC, is a US-based cryptocurrency exchange and custodian founded in 2014 by Cameron and Tyler Winklevoss. It is a New York trust company regulated by the New York State Department of Financial Services (NYDFS)."
  - question: "Is Gemini safe?"
    answer: "Gemini is a regulated US exchange that emphasizes security and compliance, holds a NYDFS trust charter, and offers insurance on assets held in its hot wallets. It is still a custodial platform, and its Earn program was affected by the 2022 Genesis collapse, later resolved through a settlement that returned assets to users."
  - question: "What are Gemini's fees?"
    answer: "Gemini's simple mobile and web pricing can be higher than some competitors, while its ActiveTrader interface offers lower maker and taker fees. Check the current fee schedule on Gemini's site before trading."
  - question: "Is Gemini available in my country?"
    answer: "Gemini serves the United States and a number of other countries. Supported regions and features vary, so confirm availability for your location on the official site."
  - question: "What is Gemini Custody?"
    answer: "Gemini Custody is the company's institutional-grade cold storage service, offered under its New York trust charter. It holds assets offline in segregated accounts, separately from the exchange business, and is aimed at institutions rather than retail users."
  - question: "What is GUSD?"
    answer: "GUSD, the Gemini Dollar, is a US dollar-backed stablecoin issued by Gemini under NYDFS oversight. It is intended to be redeemable one-to-one for US dollars."
social:
...
<ExchangeButton href="https://www.gemini.com" text="Join Gemini" />
