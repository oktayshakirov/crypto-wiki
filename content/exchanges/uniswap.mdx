---
title: "Uniswap"
meta_title: "Uniswap Review: The Original AMM DEX, Fees & UNI Token"
...
quickFacts:
  founded: "2018"
  headquarters: "New York, United States (Uniswap Labs)"
  founder: "Hayden Adams"
  type: "Decentralized exchange (DEX), automated market maker"
  custody: "Non-custodial; you keep control of your own keys"
  token: "UNI"
  availability: "Permissionless protocol; the official interface may restrict some tokens and regions"
faqs:
  - question: "What is Uniswap?"
    answer: "Uniswap is a decentralized exchange (DEX) protocol launched in 2018 by Hayden Adams. It runs on Ethereum and several other networks and uses automated market makers and liquidity pools instead of an order book, letting users swap tokens directly from their own wallets."
  - question: "Is Uniswap safe?"
    answer: "Uniswap is non-custodial, so you keep control of your funds and there is no exchange that can become insolvent with your assets. The risks are different rather than absent: smart-contract bugs, fake or scam tokens since anyone can create a pool, slippage and front-running, and the fact that mistaken transactions are irreversible with no support desk to reverse them."
  - question: "Do I need an account or KYC to use Uniswap?"
    answer: "No. Uniswap is a permissionless protocol accessed with a self-custody wallet, so there is no account, no sign-up, and no identity verification. The official web interface may still restrict certain tokens or regions."
  - question: "What are Uniswap's fees?"
    answer: "Swaps pay a liquidity provider fee, commonly 0.3 percent though it varies by pool tier, plus the network gas fee of the underlying blockchain, which can change substantially with congestion."
  - question: "What is impermanent loss?"
    answer: "If you supply tokens to a liquidity pool and their relative prices diverge, you can end up with less value than if you had simply held the tokens. This is called impermanent loss, and it can outweigh the fees you earn."
social:
...
Uniswap was created by former Siemens mechanical engineer **Hayden Adams**. After being laid off in 2017, he was encouraged by his friend Karl Floersch to learn Ethereum programming. Inspired by a blog post from **[Vitalik Buterin](/crypto-ogs/vitalik-buterin)** on the concept of on-chain market makers, Adams spent the next year building and refining the protocol. He launched Uniswap v1 at the Devcon 4 conference in November 2018 with the help of a grant from the Ethereum Foundation, laying one of the most important cornerstones of the DeFi movement.
...
![A trading chart open on a phone held in front of a laptop terminal, the everyday swapping view](/images/posts/what-is-a-dex.jpg)
