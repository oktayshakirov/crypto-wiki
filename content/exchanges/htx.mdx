---
title: "HTX"
meta_title: "HTX Review: Fees, Leverage, Staking & Is It Safe? (ex-Huobi)"
...
faqs:
  - question: "What is HTX?"
    answer: "HTX is a global cryptocurrency exchange founded in 2013 as Huobi and rebranded to HTX in 2023. It offers spot and derivatives trading along with staking and earn products."
  - question: "Is HTX safe?"
    answer: "HTX publishes proof-of-reserves and keeps a majority of assets in cold storage, but it has faced scrutiny over past security incidents and its close association with Justin Sun. It is a custodial exchange, so counterparty risk applies."
  - question: "Why did Huobi change its name to HTX?"
    answer: "Huobi rebranded to HTX in 2023, coinciding with its tenth anniversary and a shift toward a more global identity. The letters reference Huobi, TRON, and exchange."
  - question: "Does HTX serve US customers?"
    answer: "HTX does not serve users in the United States and restricts several other jurisdictions. Check the terms of service before signing up."
social:
...
- **Liquidity by Market Cap:**
  ...
  - Depth is strong on majors and popular mid‑caps; long‑tail tokens can have thin books. For large orders, consider time‑weighted execution or splitting trades to minimize slippage, and compare price impact to peers like **Bybit** or **KuCoin** when applicable.
