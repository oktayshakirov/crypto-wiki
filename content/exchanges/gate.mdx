---
title: "Gate"
meta_title: "Gate Review: Altcoin Listings, Derivatives & Trading Fees"
...
faqs:
  - question: "What is Gate?"
    answer: "Gate, formerly Gate.io, is a global cryptocurrency exchange founded in 2013. It is known for listing a very large number of altcoins alongside spot, margin, and derivatives markets."
  - question: "Is Gate safe?"
    answer: "Gate publishes regular proof-of-reserves audits and keeps most assets in cold storage. It experienced a security incident in 2018 involving a compromised third-party service. It is custodial, so standard exchange risks apply."
  - question: "What are Gate's fees?"
    answer: "Gate uses a tiered maker and taker fee model with discounts based on 30-day volume and GT token holdings. Verify current rates on the official fee page."
  - question: "Does Gate serve US customers?"
    answer: "Gate restricts US users from its main platform. Check the current terms of service for the full list of restricted jurisdictions."
social:
...
- **Altcoin Volatility:** Long-tail listings can move fast on news and liquidity shocks. Understanding **crypto volatility** helps manage these risks. Avoid overexposure to thin books. Limit orders and position sizing rules help.
- **Education and Scams:** Phishing, duplicate app downloads, and fake airdrops are perennial threats. Review **How to Avoid Crypto Scams** before enabling API keys or joining social trading groups.
