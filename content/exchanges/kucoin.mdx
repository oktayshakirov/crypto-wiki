---
title: "KuCoin"
meta_title: "KuCoin Wiki: Company Profile, Fees, KCS & Is It Safe?"
image: "/images/exchanges/kucoin.jpg"
description: "KuCoin is a global exchange with one of the widest altcoin selections and KCS fee discounts. It left the US in 2024."
date: 2024-07-27
updated: 2026-07-23
order: 5
...
quickFacts:
  ...
  founder: "Michael Gan and Kent Li"
  ceo: "Johnny Lyu (since 2020)"
  type: "Centralized exchange (CEX)"
  users: "Over 30 million users across 200+ countries"
  custody: "Custodial"
  token: "KCS"
  availability: "Global; not available to US residents"
faqs:
  - question: "What is KuCoin?"
    answer: "KuCoin is a global cryptocurrency exchange founded in 2017, known for offering one of the largest selections of altcoins alongside spot, futures, staking, and lending products."
  - question: "Is KuCoin safe?"
    answer: "KuCoin uses cold storage and standard security measures and reimbursed users after a major hack in 2020. It was charged by US authorities in 2024 and, under a settlement reached in 2025, agreed to stop serving the US market. It is a custodial exchange, so counterparty and security risks apply."
  - question: "Where is KuCoin from?"
    answer: "KuCoin launched in 2017 with a team originally based in Asia. Its main operating entity is registered in the Seychelles, and it runs internationally through a range of global entities rather than from a single national head office."
  - question: "Can US users access KuCoin?"
    answer: "No. After being charged by US authorities in 2024, KuCoin settled in 2025 and agreed to stop serving customers in the United States, so US residents should not use the platform."
  - question: "What features does KuCoin offer?"
    answer: "KuCoin offers spot and futures trading, margin, automated trading bots, staking and earn products, and a launchpad for new token sales. Its main draw is the sheer breadth of altcoins listed."
social:
...
**KuCoin is a global cryptocurrency exchange launched in September 2017 by Michael Gan and Kent Li, known for listing one of the widest selections of altcoins of any major exchange.** It offers spot, margin and futures trading, trading bots, staking and its KCS token, and serves over 30 million users.

Often called "The People's Exchange," KuCoin is headquartered in Seychelles and, after being charged by US authorities in 2024, settled in 2025 and stopped serving the United States. It also lists **[Bitcoin](/posts/what-is-bitcoin)**, **[Ethereum](/posts/what-is-ethereum)** and hundreds of smaller-cap **[Altcoins](/posts/what-are-altcoins)**.
...
![A judge gavel resting on a dark desk, reflecting the regulatory actions KuCoin has faced](/images/posts/regulators.jpg)
