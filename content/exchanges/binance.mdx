---
title: "Binance"
meta_title: "Binance Wiki: Company Profile, Fees, BNB & Safety"
...
quickFacts:
  founded: "2017"
  headquarters: "No single public headquarters"
  founder: "Changpeng Zhao (CZ) and He Yi"
  ceo: "Richard Teng (since November 2023, succeeding Changpeng Zhao)"
  users: "Over 300 million registered users"
  type: "Centralized exchange (CEX)"
  custody: "Custodial"
  token: "BNB"
  availability: "Global; US residents must use the separate Binance.US"
faqs:
  - question: "What is Binance?"
    answer: "Binance is the world's largest cryptocurrency exchange by trading volume, founded in 2017 by Changpeng Zhao (CZ). It offers spot and derivatives trading, staking, savings products, and a wider ecosystem that includes BNB Chain."
  - question: "Is Binance safe?"
    answer: "Binance is the largest exchange by volume, maintains an emergency insurance fund known as SAFU, and publishes proof-of-reserves. In November 2023 it agreed to a 4.3 billion dollar settlement with US authorities and CZ stepped down as CEO. It remains a custodial exchange, so counterparty risk applies."
  - question: "What are Binance's fees?"
    answer: "Binance uses a tiered maker and taker model that is among the lowest in the industry, with additional discounts for paying fees in BNB and for higher 30-day trading volume. Check the official fee schedule for current rates."
  - question: "Can US users trade on Binance?"
    answer: "Not on Binance.com. US residents must use Binance.US, a separate entity with fewer coins and features. Availability also varies in other countries due to local regulation."
  - question: "What is BNB?"
    answer: "BNB is Binance's native token. It is used for trading fee discounts and powers BNB Chain, and its supply is periodically reduced through token burns."
social:
...
As one of the world's largest cryptocurrency exchanges, Binance implements extensive security measures to protect user assets and data:
