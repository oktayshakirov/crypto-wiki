---
title: "Nexo"
meta_title: "Nexo Wiki: Company Profile, Rates, NEXO Token & Safety"
...
quickFacts:
  founded: "2017 (platform launched 2018)"
  headquarters: "Zug, Switzerland"
  founder: "Antoni Trenchev, Kosta Kantchev and Georgi Shulev"
  ceo: "Antoni Trenchev, co-founder and managing partner"
  type: "Crypto lending and borrowing platform"
  custody: "Custodial"
  token: "NEXO"
  availability: "Global; limited US availability following its 2023 settlement"
faqs:
  - question: "Is Nexo safe?"
    answer: "Nexo is a centralized custodial platform that stores client assets with regulated third-party custodians and publishes real-time attestations of its reserves. Assets held by those custodians carry custodial insurance against theft and hacking. That said, you do not hold your own private keys, so counterparty risk applies, and Nexo settled with US regulators in 2023 and wound down its US Earn product."
  - question: "How does Nexo make money?"
    answer: "Nexo earns mainly from the interest spread between what it pays depositors and what it charges borrowers on crypto-backed loans, plus fees from its exchange, swaps, and card products."
  - question: "What are Nexo loyalty levels?"
    answer: "Nexo has four loyalty tiers, Base, Silver, Gold, and Platinum, based on the share of NEXO tokens in your portfolio. Higher tiers unlock better earning rates, cheaper borrowing, and more free withdrawals each month."
  - question: "Is Nexo insured?"
    answer: "Nexo states that assets held by its qualified custodians are covered by custodial insurance against theft and hacks. This is custodial insurance from private providers, not government deposit insurance like FDIC, and it does not protect against market losses or a drop in crypto prices."
  - question: "Nexo vs Coinbase: what is the difference?"
    answer: "Coinbase is primarily a US-regulated exchange for buying, selling, and trading crypto, while Nexo focuses on crypto-backed lending and interest-earning accounts. Coinbase serves US customers broadly, whereas Nexo has limited US availability following its 2023 regulatory settlement."
  - question: "What is the Nexo credit line wallet?"
    answer: "A Nexo credit line lets you borrow cash or stablecoins against crypto you deposit as collateral, without selling it. The borrowed funds appear in a credit line wallet, and your collateral stays locked until you repay."
  - question: "How do Nexo loans work?"
    answer: "You deposit crypto as collateral and can borrow against it instantly with no credit check. The interest rate depends on your loyalty tier and how much you borrow relative to your collateral. There is no fixed repayment schedule as long as the loan stays within the required loan-to-value ratio."
  - question: "What is LTV on Nexo and can I be liquidated?"
    answer: "Loan-to-value (LTV) is the size of your loan relative to your collateral, and each asset has a maximum LTV. If your collateral falls in value and your LTV rises above the limit, Nexo can automatically sell part of your collateral to repay the loan. This is liquidation, and in volatile markets it can happen quickly."
social:
...
**Nexo is a crypto lending and borrowing platform founded in 2017, best known for crypto-backed credit lines and interest-earning accounts.** Users deposit crypto as collateral to borrow cash or stablecoins, or lend assets to earn yield. It also runs a crypto exchange, a payment card and the NEXO token.

Nexo has limited US availability following a 2023 settlement with the SEC and state regulators over its Earn Interest Product, and holds customer crypto custodially through third-party custodians.
