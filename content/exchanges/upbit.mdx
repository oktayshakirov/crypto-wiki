---
title: "Upbit"
meta_title: "Upbit Wiki: Company Profile, Fees, KRW Markets & Safety"
...
quickFacts:
  ...
  owner: "Operated by Dunamu"
  ceo: "Oh Kyoung-suk, CEO of Dunamu since July 2025 (succeeding Lee Sirgoo)"
  type: "Centralized exchange (CEX)"
  custody: "Custodial"
  regulation: "Registered with South Korea's Financial Intelligence Unit"
  availability: "Primarily South Korea, plus regional entities"
faqs:
  - question: "Is Upbit safe?"
    answer: "Upbit is South Korea's largest exchange, operated by Dunamu and registered with Korean regulators. It keeps the majority of assets in cold storage. It experienced a hot-wallet hack in 2019 but covered the user losses. It remains a custodial exchange that primarily serves the Korean market."
  - question: "What are Upbit's fees?"
    answer: "Upbit charges relatively low trading fees on its KRW market compared with many global exchanges. Fee rates vary by market and can change, so verify the current schedule on Upbit's official fee page."
  - question: "What is the minimum order amount on Upbit?"
    answer: "On Upbit's KRW market the minimum order amount is typically 5,000 KRW. Minimums can differ by market and are set by the exchange."
  - question: "Can I use Upbit outside South Korea?"
    answer: "Upbit operates primarily in South Korea and also runs regional entities such as Upbit Singapore. Availability, supported coins, and features depend on your country and local regulations."
  - question: "What is the Upbit market code format?"
    answer: "Upbit market codes combine the quote currency and the base asset separated by a hyphen, such as KRW-BTC for Bitcoin priced in Korean won, or USDT-ETH for Ethereum priced in Tether. This format is used throughout Upbit's public API."
social:
...
**Upbit is a South Korea-based cryptocurrency exchange launched in 2017 and operated by Dunamu.** It is the largest exchange in South Korea by volume and one of the largest spot markets in the world, built around Korean won (KRW) trading pairs. It is best known for deep KRW liquidity, a broad altcoin selection and a conservative, spot-focused product set.
